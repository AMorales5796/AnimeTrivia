public class HighLow implements Comparable<HighLow>
{
    ...
    public HighLow(String questions, int correctAnswer, int guess, int count, int countCorrect)
    {
    ...
    public String endOfRound()
    {
        ...
        public int compareTo(HighLow someQuestion)
    {
