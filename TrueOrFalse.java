public class TrueOrFalse implements Comparable<TrueOrFalse>
{
    ...
    public TrueOrFalse(String questions, int correctAnswer, int guess, int count, int countCorrect)
    {
    ...
    public int compareTo(TrueOrFalse someTOFQuestion)
    {
